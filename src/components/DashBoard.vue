    ...
    <div>
      ...
      <div id="burguer-table-rows">
        <div class="burguer-table-row" v-for="burguer in burguers" :key="burguer.id">
          ...
          <div>
            <select class="status" name="status" id="" @change="updateStatus(burguer.id,$event)">
              <option value="">Status</option>
              <option v-for="now in status" :key="now.id" :value="now.tipo" :selected="burguer.status == now.tipo">{{now.tipo}}</option>
            </select>
            <button @click="deleteBurguer(burguer.id)" class="delete-btn">Cancelar</button>
          </div>
        </div>
      </div>
    </div>
